...
public class ServerThread extends DataManager implements Runnable
{
	//I/O variables 
 ...
 */
			...
			ArrayList<userObj> userList = getUserList();
			if(userList.contains(usernameHash)){
					isReturning = true;
			}
			...
			else
			{
				...
				else
				{
					...
					addUser(user);
					//Send over the shared secret amongst the network.
