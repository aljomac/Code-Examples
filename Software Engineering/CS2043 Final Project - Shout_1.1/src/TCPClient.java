...
public class TCPClient extends DataManager
{
	...
	private static boolean readyForPin = false;
	...
	public static void main(String argv[]) throws Exception
	{
		 ...
		 * After this one is used, the new IV comes from the random crap r
	...
	//
	//=======================================
	public static void exchangeSecret(String theSecret, ObjectInputStream inFromServer, PrivateKey privateKeyForStorage) throws Exception
	{
		/*
